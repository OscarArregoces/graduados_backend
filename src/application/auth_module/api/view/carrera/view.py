...
from src.application.auth_module.api.serializers.person.persons_serializers import PersonsDetailSerializers
from src.application.auth_module.models import Carrera, User
